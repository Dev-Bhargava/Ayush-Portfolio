...
jQuery(document).ready(function($) {
  ...
  function js_product_flashsale(){
    ...
    function js_product_flashsale_v2(){
    $('.slick_product_flashsale_v2').slick({
      arrows: true,
      infinite: true,
      dots: false ,
      speed: 300,
  ...
  function bannerv8() {
    $('.js-banner-v8').slick({
      ...
      nextArrow:'<button type="button" class="next-slide"><i class="fas fa-long-arrow-alt-right"></i></button>',
      responsive: [
        {
          breakpoint: 1880,
          settings: {
